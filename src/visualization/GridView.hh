...
public:
    ...
    void setDrawP ( bool val )
    {
        drawP = val;
        update();
        saveSettings();
    }
    void setDrawCells      ( bool val )
    {
        drawCells   = val;
        update();
        saveSettings();
    }
    void setDrawArrows     ( bool val )
    {
        drawArrows  = val;
        update();
        saveSettings();
    }
    void setDrawLabels     ( bool val )
    {
        drawLabels  = val;
        update();
        saveSettings();
    }
    void setDrawCellIndices( bool val )
    {
        drawIndices = val;
        update();
        saveSettings();
    ...
    bool getDrawCellIndices()const
    {
        return drawIndices;
    }

    void setGrid(const StaggeredGrid *g);
    const StaggeredGrid *getGrid() const
    {
        return grid;
    }
